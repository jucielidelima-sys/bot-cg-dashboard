    ...
    for i, row in top.iterrows():
        ...
        <div class="rank-row">
            <div class="rank-header">
                <div class="rank-name">#{len(html_parts)+1} • {nome}</div>
...
with col_head:
    ...
    <div class="metal-header">
        ...
        <div class="metal-subtitle">Painel industrial 4.0 • Glassmorphism Tesla • Sala de controle operacional</div>
    </div>
    """, unsafe_allow_html=True)
...
with aba1:
    ...
    # IA simples: projeção de gargalo
    # Heurística: carga futura = carga atual * fator_previsao
    # score = util_projetada + peso por diversidade de modelos
